...
| 2021/1/31 | [839. 相似字符串组](https://leetcode-cn.com/problems/similar-string-groups/) | 并查集，俩俩相似即可的特性特别像连通图，所以通过遍历每一对字符串，判断是否相似，相似则加入并查集合并，最后并查集的连通分量就是答案 |

## 月度总结

这个月的大部分题目跟并查集有关，我也从0学起了并查集，到现在能快速的手写并查集模板并运用其特性

逐渐增加的刷题量也让我意识到原来薄弱的算法与数据结构动手能力，只有真正写出来才能更好的理解。

一月没能达成全勤记录，有点可惜，希望之后加油！